 ...
 return (
   <header>
    <nav className="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      <Link className="navbar-brand" to="/">Linta Shoppe</Link>
      ...
      <div className="collapse navbar-collapse" id="navbarCollapse">
        <ul className="navbar-nav mr-auto">
          <li className="nav-item">
            <Link className="nav-link" to='/'>Home<span className="sr-only">(current)
            </span>
            </Link>
          </li>
        </ul>
        ...
        <form>
          ...
          <button>
            <svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-search" fill="white" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Search button Ends  */}
        ...
        <div>
            <Link className="nav-link" to='/cart'>
              <svg width="2em" height="2em" viewBox="0 0 16 16" className="bi bi-basket" fill="white" xmlns="http://www.w3.org/2000/svg">
